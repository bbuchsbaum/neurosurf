...
```{r quickstart, message = FALSE, fig.alt = "Lateral and medial views of both fsaverage hemispheres with red and blue thresholded z-map clusters over grey curvature shading", fig.width = 8, fig.height = 5, out.width = "100%"}
library(neurosurf)
...
- **Read and write surfaces and data**: FreeSurfer, GIFTI, AFNI/SUMA, and NIML
  ...
  fsaverage templates (`load_fsaverage()`, `load_fsaverage_std8()`).
