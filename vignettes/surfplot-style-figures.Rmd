...
output:
  rmarkdown::html_vignette:
    ...
    includes:
      ...
      - albers-header.html
vignette: |
  %\VignetteIndexEntry{Surfplot-style Figures with neurosurf} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
params:
  family: teal
  preset: homage
resource_files:
...
```{r render-figure, fig.width=8, fig.height=4, results='asis'}
g <- draw_surface_plot(
  p,
  colorbar      = TRUE,
...
grDevices::png(fig_file, width = 1536, height = 768, bg = "white")
grid::grid.newpage()
grid::grid.draw(g)
grDevices::dev.off()
